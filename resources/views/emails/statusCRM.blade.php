                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          ...
                          <td align="left" style="padding: 25px 0 0 0;" width="50%">
                            {{ $crmaction->c_r_m->created_at->format('d/m/Y H:i') }}
                          </td>
                        </tr>
                        <tr>
                          <td align="right" style="padding: 25px 0 0 0;" width="50%">
                            <strong>Nº CRM:&#160;&#160;&#160;</strong>
                          </td>
                          <td align="left" style="padding: 25px 0 0 0;" width="50%">
                            {{$crmaction->c_r_m->created_at->format('my').substr('00000'.$crm->id, -5)}}
                          </td>
                        </tr>
                        <tr>
                          <td align="right" style="padding: 25px 0 0 0;" width="50%">
                  ...
                  <tr>
                    <td width="75%">
                      <center>Atenciosamente,
                        <br>{{$crmaction->c_r_m->seller->name}}
                        <br><a>comercial@jesistemas.com.br</a>
