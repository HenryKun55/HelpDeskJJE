                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('ramal') ? ' has-error' : '' }}" >
                            ...
                            <div class="col-md-6">
                                <input id="ramal" type="ramal" class="form-control" name="ramal" value="{{ old('ramal') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('setor') ? ' has-error' : '' }}" >
                            ...
                            <div class="col-md-6">
                                <input id="setor" type="setor" class="form-control" name="setor" value="{{ old('setor') }}" required>
